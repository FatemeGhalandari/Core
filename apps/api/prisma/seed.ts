...
async function seedDemoWorkspace(
  ...
  await prisma.user.deleteMany({
    where: {
      email: {
        in: config.users.map((user) => user.email),
      },
    },
  });
...
const demoWorkspaces: DemoWorkspaceConfig[] = [
  ...
  },
  {
    ...
    customerLabel: "Client",
    industryTemplateKey: "cleaning",
    referencePrefix: "CLN",
    users: [
      {
        name: "Maya Fraser",
        email: "owner@brightnest-cleaning.test",
        role: Role.owner,
      },
      {
        name: "Evan Brooks",
        email: "admin@brightnest-cleaning.test",
        role: Role.admin,
      },
      {
        name: "Sofia Tremblay",
        email: "dispatch@brightnest-cleaning.test",
        role: Role.staff,
      },
      {
        name: "Andre Wilson",
        email: "lead@brightnest-cleaning.test",
        role: Role.staff,
      },
      {
        name: "Nadia Khan",
        email: "quality@brightnest-cleaning.test",
        role: Role.staff,
      },
    ],
    customers: customers("brightnest-clients.test", [
      ["Claire Morrison", "+1 416-555-0401"],
      ["Ravi Menon", "+1 647-555-0402"],
      ["Bianca Rossi", "+1 905-555-0403"],
      ["Noah Sinclair", "+1 437-555-0404"],
      ["Aisha Grant", "+1 416-555-0405"],
      ["Hudson Property Group", "+1 905-555-0406"],
      ["Maple Lofts Condo Board", "+1 647-555-0407"],
      ["Driftwood Dental Studio", "+1 416-555-0408"],
      ["Lena Park", "+1 289-555-0409"],
      ["OmniBuild Renovations", "+1 905-555-0410"],
      ["Theo Campbell", "+1 647-555-0411"],
      ["Northline Design Office", "+1 416-555-0412"],
    ]),
    cases: [
      {
        customerEmail: "claire.morrison@brightnest-clients.test",
        title: "Standard house cleaning - 3 bedroom home",
        description:
          "Standard recurring house cleaning for bedrooms, bathrooms, kitchen surfaces, dusting, vacuuming, and mopping.",
        priority: Priority.normal,
        statusName: "Booking Confirmed",
        categoryName: "Recurring Maid Service",
        assignedEmail: "dispatch@brightnest-cleaning.test",
        dueInDays: 2,
        intakeData: {
          serviceType: "Recurring maid service",
          serviceAddress: "148 Logan Ave, Toronto, ON M4M 2M8",
          propertyType: "Single-family home",
          propertySize: "1800",
          bedroomCount: "3",
          bathroomCount: "2",
          preferredServiceDate: "2026-08-14",
          serviceFrequency: "Bi-weekly service",
          addOnServices: "Home organization",
          accessInstructions: "Street parking usually opens after 10 AM.",
          specialInstructions: "Use fragrance-free products. Focus on floors, bathrooms, and kitchen counters.",
        },
        comments: ["Recurring two-person crew booked for Friday mornings."],
      },
      {
        customerEmail: "ravi.menon@brightnest-clients.test",
        title: "Move-out cleaning - 1 bedroom condo",
        description:
          "Full empty-unit move-out cleaning with oven, fridge, bathroom, baseboards, cabinets, closets, and floors.",
        priority: Priority.high,
        statusName: "Crew Assigned",
        categoryName: "Move-In / Move-Out Cleaning",
        assignedEmail: "lead@brightnest-cleaning.test",
        dueInDays: 1,
        intakeData: {
          serviceType: "Move-out clean",
          serviceAddress: "Unit 1906, 12 York St, Toronto, ON M5J 0A9",
          propertyType: "Condo or apartment",
          propertySize: "720",
          bedroomCount: "1",
          bathroomCount: "1",
          preferredServiceDate: "2026-08-12",
          serviceFrequency: "One-time service",
          addOnServices: "Oven interior, Fridge interior, Interior windows",
          accessInstructions: "Concierge has fob under Menon unit turnover.",
          specialInstructions: "Clean all empty cabinets, appliances, bathroom grout, baseboards, and balcony door glass.",
        },
        comments: ["Crew assigned for empty-unit move-out clean."],
      },
      {
        customerEmail: "bianca.rossi@brightnest-clients.test",
        title: "Deep cleaning - bathrooms and baseboards",
        description:
          "One-time deep clean for bathrooms, baseboards, doors, trim, shower glass, kitchen fronts, and floors.",
        priority: Priority.normal,
        statusName: "Awaiting Client Confirmation",
        categoryName: "Deep Cleaning",
        assignedEmail: "quality@brightnest-cleaning.test",
        dueInDays: 4,
        intakeData: {
          serviceType: "Deep cleaning",
          serviceAddress: "226 Lakeshore Rd W, Oakville, ON L6K 1E8",
          propertyType: "Townhouse",
          propertySize: "2100",
          bedroomCount: "4",
          bathroomCount: "3",
          preferredServiceDate: "2026-08-18",
          serviceFrequency: "One-time service",
          addOnServices: "Cabinet interiors, Interior windows",
          accessInstructions: "Driveway parking available.",
          specialInstructions: "Avoid bleach. Spend extra time on bathrooms, baseboards, stair rails, and cabinet fronts.",
        },
        comments: ["Waiting for client to confirm the deep clean date."],
      },
      {
        customerEmail: "noah.sinclair@brightnest-clients.test",
        title: "Post-construction dust cleaning",
        description:
          "Post-construction clean for drywall dust on vents, ledges, cabinet interiors, floors, trim, windows, and fixtures.",
        priority: Priority.high,
        statusName: "Cleaning In Progress",
        categoryName: "Post-Construction Cleanup",
        assignedEmail: "lead@brightnest-cleaning.test",
        dueInDays: 0,
        intakeData: {
          serviceType: "Post-construction cleanup",
          serviceAddress: "64 Royal York Rd, Etobicoke, ON M8V 2T8",
          propertyType: "Single-family home",
          propertySize: "1450",
          bedroomCount: "2",
          bathroomCount: "2",
          preferredServiceDate: "2026-08-10",
          serviceFrequency: "One-time service",
          addOnServices: "Interior windows, Cabinet interiors",
          accessInstructions: "Contractor lockbox on side gate.",
          specialInstructions: "Use HEPA vacuum and microfiber wipe-downs on all ledges, vents, and cabinet interiors.",
        },
        comments: ["Crew is completing second-pass dust removal and final mop."],
      },
      {
        customerEmail: "aisha.grant@brightnest-clients.test",
        title: "Light apartment cleaning with laundry",
        description:
          "Light apartment clean covering laundry, bathroom sanitizing, kitchen surfaces, dusting, vacuuming, and floor mopping.",
        priority: Priority.normal,
        statusName: "Awaiting Client Confirmation",
        categoryName: "Apartment & Condo Cleaning",
        dueInDays: 3,
        intakeData: {
          serviceType: "Standard home cleaning",
          serviceAddress: "Unit 703, 88 Broadway Ave, Toronto, ON M4P 0A5",
          propertyType: "Condo or apartment",
          propertySize: "950",
          bedroomCount: "2",
          bathroomCount: "2",
          preferredServiceDate: "2026-08-15",
          serviceFrequency: "Requesting a quote",
          addOnServices: "Laundry, Home organization",
          accessInstructions: "Visitor parking on P2.",
          specialInstructions: "Use quiet cleaning routine and fragrance-free products.",
        },
        comments: ["Quote sent; waiting for client confirmation before booking."],
      },
      {
        customerEmail: "hudson.property.group@brightnest-clients.test",
        title: "Move-in cleaning - three apartment suites",
        description:
          "Move-in cleaning for three empty apartment suites, including kitchens, bathrooms, appliances, closets, cabinets, and floors.",
        priority: Priority.high,
        statusName: "Crew Assigned",
        categoryName: "Move-In / Move-Out Cleaning",
        assignedEmail: "dispatch@brightnest-cleaning.test",
        ...
        intakeData: {
          ...
          serviceAddress: "220 Burnhamthorpe Rd W, Mississauga, ON L5B 4N4",
          propertyType: "Condo or apartment",
          propertySize: "2550",
          bedroomCount: "5",
          bathroomCount: "4",
          preferredServiceDate: "2026-08-13",
          serviceFrequency: "One-time service",
          addOnServices: "Oven interior, Fridge interior, Cabinet interiors",
          accessInstructions: "Building manager will provide suite keys.",
          specialInstructions: "Finish kitchens and bathrooms first in suites 702 and 811.",
        },
        comments: ["Two crews assigned to clean three empty suites in one day."],
      },
      {
        customerEmail: "maple.lofts.condo.board@brightnest-clients.test",
        title: "Condo lobby, gym, and party room cleaning",
        description:
          "Common-area cleaning for condo lobby glass, mailroom counters, gym mirrors, party room surfaces, floors, and washrooms.",
        priority: Priority.normal,
        statusName: "Booking Confirmed",
        categoryName: "Apartment & Condo Cleaning",
        assignedEmail: "quality@brightnest-cleaning.test",
        ...
        intakeData: {
          serviceType: "Recurring maid service",
          serviceAddress: "35 Merton St, Toronto, ON M4S 3G4",
          propertyType: "Other commercial site",
          propertySize: "3200",
          bedroomCount: "0",
          bathroomCount: "4",
          preferredServiceDate: "2026-08-17",
          serviceFrequency: "Monthly service",
          addOnServices: "Interior windows",
          accessInstructions: "Security desk will issue contractor badges.",
          specialInstructions: "Clean lobby glass, gym mirrors, mailroom counters, and amenity washrooms.",
        },
        comments: ["Monthly common-area cleaning booked for lobby and amenities."],
      },
      {
        customerEmail: "driftwood.dental.studio@brightnest-clients.test",
        title: "After-hours office cleaning - reception and washrooms",
        description:
          "After-hours commercial cleaning for reception desks, waiting area, staff room, floors, glass, waste bins, and washrooms.",
        priority: Priority.normal,
        ...
        intakeData: {
          ...
          serviceAddress: "410 Queen St W, Toronto, ON M5V 2A7",
          propertyType: "Medical or professional office",
          propertySize: "1600",
          bedroomCount: "0",
          bathroomCount: "2",
          preferredServiceDate: "2026-08-20",
          serviceFrequency: "Weekly service",
          addOnServices: "Interior windows",
          accessInstructions: "Service must start after 7 PM.",
          specialInstructions: "Clean only reception, staff areas, floors, glass, and washrooms.",
        },
        comments: ["Weekly after-hours office cleaning estimate sent."],
      },
      {
        customerEmail: "lena.park@brightnest-clients.test",
        title: "Oven, fridge, and bathroom deep clean",
        description:
          "Completed deep clean for oven interior, fridge interior, stovetop, sinks, tubs, toilets, vanities, mirrors, and floors.",
        priority: Priority.low,
        statusName: "Closed",
        categoryName: "Deep Cleaning",
        assignedEmail: "quality@brightnest-cleaning.test",
        ...
        intakeData: {
          serviceType: "Deep cleaning",
          serviceAddress: "92 Bur Oak Ave, Markham, ON L6C 2E4",
          propertyType: "Townhouse",
          propertySize: "1900",
          bedroomCount: "3",
          bathroomCount: "3",
          preferredServiceDate: "2026-08-06",
          serviceFrequency: "One-time service",
          addOnServices: "Oven interior, Fridge interior",
          accessInstructions: "Client met crew on arrival.",
          specialInstructions: "Kitchen appliances and bathrooms were the priority areas.",
        },
        comments: ["Appliance and bathroom deep clean completed and quality checked."],
      },
      {
        customerEmail: "omnibuild.renovations@brightnest-clients.test",
        title: "Final renovation dust and window cleaning",
        description:
          "Final post-renovation cleaning for dust, windows, floors, light fixtures, trim, cabinets, counters, and bathrooms.",
        priority: Priority.high,
        statusName: "Cleaning In Progress",
        categoryName: "Post-Construction Cleanup",
        assignedEmail: "lead@brightnest-cleaning.test",
        ...
        intakeData: {
          serviceType: "Post-construction cleanup",
          serviceAddress: "18 Kingston Rd, Scarborough, ON M1N 1S5",
          propertyType: "Single-family home",
          propertySize: "2400",
          bedroomCount: "4",
          bathroomCount: "3",
          ...
          serviceFrequency: "One-time service",
          addOnServices: "Interior windows, Cabinet interiors",
          accessInstructions: "Site supervisor will unlock at 8 AM.",
          specialInstructions: "Remove dust from fixtures, trim, floors, windows, and cabinet interiors.",
        },
        comments: ["Post-renovation clean is in progress; windows and floors remain."],
      },
      {
        customerEmail: "theo.campbell@brightnest-clients.test",
        title: "Same-day house cleaning - kitchen and floors",
        description:
          "Same-day house cleaning focused on kitchen counters, sink, stovetop, bathrooms, dusting, vacuuming, mopping, and glass.",
        priority: Priority.high,
        statusName: "Booking Confirmed",
        ...
        intakeData: {
          serviceType: "Standard home cleaning",
          serviceAddress: "313 Pacific Ave, Toronto, ON M6P 2P8",
          propertyType: "Single-family home",
          propertySize: "1700",
          bedroomCount: "3",
          bathroomCount: "2",
          preferredServiceDate: "2026-08-11",
          serviceFrequency: "One-time service",
          addOnServices: "Interior windows, Home organization",
          accessInstructions: "Realtor lockbox on front railing.",
          specialInstructions: "Clear counters, polish fixtures, clean floors, and wipe visible glass before photos.",
        },
        comments: ["Same-day cleaning booked with extra kitchen and floor time."],
      },
      {
        customerEmail: "northline.design.office@brightnest-clients.test",
        title: "Weekly office cleaning - desks, kitchenette, washrooms",
        description:
          "Weekly office cleaning for desks, meeting rooms, kitchenette, floors, waste bins, glass, and washrooms.",
        priority: Priority.normal,
        statusName: "Closed",
        categoryName: "Office Cleaning",
        assignedEmail: "quality@brightnest-cleaning.test",
        ...
        intakeData: {
          serviceType: "Office cleaning",
          serviceAddress: "560 King St W, Toronto, ON M5V 1M3",
          propertyType: "Office",
          propertySize: "2800",
          bedroomCount: "0",
          bathroomCount: "2",
          preferredServiceDate: "2026-08-05",
          serviceFrequency: "Weekly service",
          addOnServices: "Interior windows",
          accessInstructions: "Keycard stored with building security.",
          specialInstructions: "Clean desks around materials without moving prototype boards.",
        },
        comments: ["Weekly office cleaning completed and recurring plan activated."],
      },
    ],
  },
  {
